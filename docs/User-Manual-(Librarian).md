...
- Fill in all the fields properly and click on Register
- If there is an error in any of the fields then an error message will be displayed
- Upon successful registration, a Message Box with your Username will be displayed, and please note the same![Screenshot of login page](Screenshots/Register_librarian.PNG)
...
- To clear search results, click on the "Clear Search" Button
![Screenshot of login page](Screenshots/Search_member.PNG)
...
![Screenshot of login page](Screenshots/Upd_del_book.PNG)
