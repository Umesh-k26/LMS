...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->member_profile_group->Location = System::Drawing::Point(59, 56);
			this->member_profile_group->Name = L"member_profile_group";
			this->member_profile_group->Size = System::Drawing::Size(399, 354);
			...
			// dob_member_txt
			// 
			this->dob_member_txt->Location = System::Drawing::Point(171, 97);
			this->dob_member_txt->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->dob_member_txt->Name = L"dob_member_txt";
			this->dob_member_txt->ReadOnly = true;
			this->dob_member_txt->Size = System::Drawing::Size(101, 20);
			this->dob_member_txt->TabIndex = 18;
			// 
			// member_id_txt
			// 
			this->member_id_txt->Location = System::Drawing::Point(171, 27);
			this->member_id_txt->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->member_id_txt->Name = L"member_id_txt";
			this->member_id_txt->ReadOnly = true;
			this->member_id_txt->Size = System::Drawing::Size(99, 20);
			this->member_id_txt->TabIndex = 17;
			// 
			// member_id_lbl
			// 
			this->member_id_lbl->AutoSize = true;
			this->member_id_lbl->Location = System::Drawing::Point(36, 25);
			this->member_id_lbl->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->member_id_lbl->Name = L"member_id_lbl";
			this->member_id_lbl->Size = System::Drawing::Size(18, 13);
			...
			this->book_profile_group->Location = System::Drawing::Point(483, 62);
			this->book_profile_group->Name = L"book_profile_group";
			this->book_profile_group->Size = System::Drawing::Size(289, 360);
			...
			this->borrow_stat_txt->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			// book_id_txt
			// 
			this->book_id_txt->Location = System::Drawing::Point(167, 19);
			this->book_id_txt->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->book_id_txt->Name = L"book_id_txt";
			this->book_id_txt->ReadOnly = true;
			this->book_id_txt->Size = System::Drawing::Size(99, 20);
			this->book_id_txt->TabIndex = 21;
			// 
			// book_id_lbl
			// 
			this->book_id_lbl->AutoSize = true;
			this->book_id_lbl->Location = System::Drawing::Point(17, 23);
			this->book_id_lbl->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->book_id_lbl->Name = L"book_id_lbl";
			this->book_id_lbl->Size = System::Drawing::Size(18, 13);
			...
			this->date_issue_lbl->Location = System::Drawing::Point(824, 69);
			this->date_issue_lbl->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->date_issue_lbl->Name = L"date_issue_lbl";
			this->date_issue_lbl->Size = System::Drawing::Size(72, 13);
			...
			this->date_return_lbl->Location = System::Drawing::Point(824, 149);
			this->date_return_lbl->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->date_return_lbl->Name = L"date_return_lbl";
			this->date_return_lbl->Size = System::Drawing::Size(77, 13);
			...
			this->fine_lbl->Location = System::Drawing::Point(841, 203);
			this->fine_lbl->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->fine_lbl->Name = L"fine_lbl";
			this->fine_lbl->Size = System::Drawing::Size(27, 13);
			...
			this->date_issue_txt->Location = System::Drawing::Point(831, 94);
			this->date_issue_txt->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->date_issue_txt->Name = L"date_issue_txt";
			this->date_issue_txt->ReadOnly = true;
			this->date_issue_txt->Size = System::Drawing::Size(70, 20);
			this->date_issue_txt->TabIndex = 29;
			// 
			// date_return_txt
			// 
			this->date_return_txt->Anchor = System::Windows::Forms::AnchorStyles::None;
			this->date_return_txt->Location = System::Drawing::Point(829, 175);
			this->date_return_txt->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->date_return_txt->Name = L"date_return_txt";
			this->date_return_txt->ReadOnly = true;
			this->date_return_txt->Size = System::Drawing::Size(68, 20);
			this->date_return_txt->TabIndex = 30;
			// 
			// order_fine_txt
			// 
			this->order_fine_txt->Anchor = System::Windows::Forms::AnchorStyles::None;
			this->order_fine_txt->Location = System::Drawing::Point(831, 237);
			this->order_fine_txt->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->order_fine_txt->Name = L"order_fine_txt";
			this->order_fine_txt->ReadOnly = true;
			this->order_fine_txt->Size = System::Drawing::Size(70, 20);
			this->order_fine_txt->TabIndex = 31;
			// 
			// order_id_lbl
			// 
			this->order_id_lbl->AutoSize = true;
			this->order_id_lbl->Location = System::Drawing::Point(270, 25);
			this->order_id_lbl->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->order_id_lbl->Name = L"order_id_lbl";
			this->order_id_lbl->Size = System::Drawing::Size(50, 13);
			this->order_id_lbl->TabIndex = 32;
			this->order_id_lbl->Text = L"Order ID:";
			// 
			// order_id_txt
			// 
			this->order_id_txt->Location = System::Drawing::Point(335, 21);
			this->order_id_txt->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->order_id_txt->Name = L"order_id_txt";
			this->order_id_txt->ReadOnly = true;
			this->order_id_txt->Size = System::Drawing::Size(90, 20);
			this->order_id_txt->TabIndex = 33;
			// 
			// back_button
			// 
			this->back_button->Location = System::Drawing::Point(8, 8);
			this->back_button->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->back_button->Name = L"back_button";
			this->back_button->Size = System::Drawing::Size(49, 29);
			...
			this->ClientSize = System::Drawing::Size(963, 662);
