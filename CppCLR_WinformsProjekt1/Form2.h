...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(296, 221);
			...
			this->button4->Size = System::Drawing::Size(179, 54);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(369, 76);
			...
			// button8
			// 
			this->button8->Location = System::Drawing::Point(110, 192);
			...
			// button7
			// 
			this->button7->Location = System::Drawing::Point(86, 310);
			...
			this->ClientSize = System::Drawing::Size(659, 528);
